// pages/communication/pcdetail/pcdetail.js
...
Page({
  ...
  submit() {
    ...
    let param = {
      ...
      'article_id': Number(this.data.pcdetail.id),
  ...
  shouchang(){
    let param = {
      'new_id' : this.data.pcdetail.id,
      'banner' : this.data.pcdetail.banner.toString(),
      'title' : this.data.pcdetail.content
    }
    console.log(param)
  ...
  getPc(id){
    communication.getCommuntyPcDetail(id).then(res => {
